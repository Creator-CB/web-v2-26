    ...
    <div id="hero" className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 py-24 min-h-[90vh] flex items-center text-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:pb-28">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto lg:mx-0 lg:max-w-none">
                ...
                <div className="flex flex-col items-center lg:items-start p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-green-500/40 hover:bg-white/10 transition-all duration-300">
                  ...
                  {/* Stat cards - moved under Fast Growth section and made smaller */}
                  <div className="mt-6 hidden lg:flex space-x-3">
                    <Card className="glass-card p-3 animate-float shadow-md border border-amber-500/30 bg-black/70 backdrop-blur-lg w-auto">
                      ...
                      <div className="text-lg font-bold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent flex items-center">
                        +24.8% <span className="text-green-400 text-xs ml-1">↗</span>
                      </div>
                    </Card>
                    
                    <Card className="glass-card p-3 animate-float [animation-delay:500ms] shadow-md border border-blue-500/30 bg-black/70 backdrop-blur-lg w-auto">
                      ...
                      <div className="text-lg font-bold bg-gradient-to-r from-amber-500 to-orange-400 bg-clip-text text-transparent flex items-center">
                        93.5% <span className="text-blue-400 text-xs ml-1">✓</span>
                      </div>
                    </Card>
                    
                    <Card className="glass-card p-3 animate-float [animation-delay:1000ms] shadow-md border border-purple-500/30 bg-black/70 backdrop-blur-lg w-auto">
                      ...
                      <div className="text-lg font-bold bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent flex items-center">
                        98.2% <span className="text-amber-300 text-xs ml-1">★</span>
                      </div>
                    </Card>
                  </div>
                </div>
          ...
          {/* Removing the previous stat cards section as we moved it under Fast Growth */}

    ...
    <div id="hero" className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 py-24 min-h-[90vh] flex items-center text-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:pb-28">
          ...
          {/* Stat cards - OPTIMIZED: reduced size, increased transparency, positioned away from text */}
          <div className="hidden lg:block absolute top-36 right-10 z-20">
            <div className="relative w-[350px] h-[350px]">
              {/* Orbital circle animation container */}
              <div className="absolute inset-0 rounded-full border border-dashed border-amber-500/20 animate-spin-slow duration-[20s]"></div>
              <div className="absolute inset-8 rounded-full border border-dashed border-blue-500/10 animate-spin-slow [animation-direction:reverse] duration-[25s]"></div>
              
              {/* First card - positioned at top of orbit */}
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <Card className="glass-card p-4 shadow-lg border border-amber-500/20 bg-black/80 backdrop-blur-md w-60 hover:scale-105 transition-transform duration-300">
              ...
              {/* Second card - positioned at right side of orbit */}
              <div className="absolute top-1/2 right-0 transform translate-y-[-50%]">
                <Card className="glass-card p-4 shadow-lg border border-blue-500/20 bg-black/80 backdrop-blur-md w-60 hover:scale-105 transition-transform duration-300">
              ...
              {/* Third card - positioned at bottom of orbit */}
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
                <Card className="glass-card p-4 shadow-lg border border-purple-500/20 bg-black/80 backdrop-blur-md w-60 hover:scale-105 transition-transform duration-300">

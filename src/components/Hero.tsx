...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100 py-24 min-h-[90vh] flex items-center">
      ...
      <div className="absolute top-1/4 right-[10%] w-80 h-80 bg-invest-purple/5 rounded-full blur-3xl animate-pulse-slow"></div>
      <div className="absolute bottom-1/4 left-[5%] w-64 h-64 bg-invest-blue/5 rounded-full blur-3xl animate-pulse-slow animation-delay-1000"></div>
      
      {/* Enhanced circular element */}
      <div className="absolute bottom-[10%] right-[5%] w-96 h-96 opacity-20">
        <div className="absolute inset-0 rounded-full border-2 border-dashed border-invest-purple/30 animate-spin-slow"></div>
        <div className="absolute inset-8 rounded-full border border-invest-blue/20 animate-spin-slow [animation-direction:reverse]"></div>
        <div className="absolute inset-16 rounded-full border border-invest-cyan/10 animate-spin-slow [animation-duration:10s]"></div>
      </div>
      
      {/* European chart visualization */}
      <div className="absolute top-[15%] right-[18%] w-72 h-48 opacity-20 hidden lg:block">
        ...
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:pb-28">
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="text-center lg:text-left">
              ...
              >
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-invest-purple/10 mr-3 shadow-sm">
                  <span className="h-3 w-3 rounded-full bg-invest-purple animate-pulse"></span>
                </span>
                <span className="text-sm font-medium uppercase tracking-wider text-invest-purple">European Investment Platform</span>
              </div>
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl md:leading-tight">
                ...
                <span className="block gradient-text mt-3 overflow-hidden h-[1.2em]">
                  {typingText}
                  <span className="animate-pulse inline-block w-1 h-[1em] bg-invest-purple ml-1 align-middle"></span>
                </span>
              </h1>
              <p 
              ...
              >
                <Button 
                  size="lg"
                  className="bg-invest-purple hover:bg-invest-purple/90 rounded-md px-8 py-6 text-base font-medium shadow-md relative overflow-hidden button-hover group"
                ...
                <Button 
                  variant="outline"
                  size="lg"
                  className="rounded-md px-8 py-6 text-base font-medium border-invest-purple text-invest-purple hover:bg-invest-purple/5 shadow-sm"
          ...
          >
            <div className="glass-card p-5 animate-float [animation-delay:0ms] shadow-lg">
              <div className="text-sm font-medium text-gray-500">Annual Returns</div>
              <div className="text-2xl font-bold gradient-text">+16.4%</div>
              <div className="text-xs text-gray-400 mt-1">Average for European portfolios</div>
            </div>
            <div className="glass-card p-5 animate-float [animation-delay:1000ms] shadow-lg">
            ...
            <div className="glass-card p-5 animate-float [animation-delay:2000ms] shadow-lg">

    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100 py-24 min-h-[90vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:pb-28">
          ...
          >
            <div className="glass-card p-5 animate-float shadow-lg border border-pink-100 bg-white/90 backdrop-blur-md z-10 relative">
            ...
            <div className="glass-card p-5 animate-float [animation-delay:1000ms] shadow-lg border border-pink-100 bg-white/90 backdrop-blur-md z-10 relative">
            ...
            <div className="glass-card p-5 animate-float [animation-delay:2000ms] shadow-lg border border-pink-100 bg-white/90 backdrop-blur-md z-10 relative">

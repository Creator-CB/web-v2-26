  ...
  const features = [
    {
      ...
      title: t("intelligentCryptoAnalysis"),
      description: t("intelligentCryptoAnalysisDesc")
    },
    {
      icon: <Shield className="h-10 w-10 text-blue-500" />,
      title: t("cryptoRiskManagement"),
      description: t("cryptoRiskManagementDesc")
    },
    {
      icon: <Bot className="h-10 w-10 text-purple-500" />,
      title: t("aiCryptoTrading"),
      description: t("aiCryptoTradingDesc")
    },
    {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center rounded-full bg-amber-500/5 px-3 py-1 mb-4 shadow-sm">
            <span className="text-sm font-medium uppercase tracking-wider text-amber-600">{t("whyChooseUs")}</span>
          </div>
        ...
        <div className="mt-28 glass-card p-10 relative overflow-hidden border border-gray-100 rounded-2xl shadow-xl">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between relative z-10">
            <div className="mb-12 md:mb-0 md:w-2/3">
              <h3 className="text-2xl font-bold mb-6 text-gray-800">{t("whyNowIsBest")}</h3>
              <ul className="space-y-5">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-3 text-gray-600">{t("institutionalAdoption")}</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <div className="flex items-center justify-center w-6 h-6 rounded-full bg-amber-500/10 shadow-sm">
                  ...
                  <span className="ml-3 text-gray-600">{t("aiAdvantage")}</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <div className="flex items-center justify-center w-6 h-6 rounded-full bg-amber-500/10 shadow-sm">
                  ...
                  <span className="ml-3 text-gray-600">{t("cryptoRegulation")}</span>
                </li>
              </ul>
            </div>

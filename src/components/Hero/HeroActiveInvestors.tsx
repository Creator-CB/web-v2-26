...
const HeroActiveInvestors = () => {
  ...
  return (
    <div className="absolute bottom-6 sm:bottom-10 left-1/2 transform -translate-x-1/2 bg-black/50 backdrop-blur-md shadow-lg rounded-full px-3 sm:px-6 py-2 sm:py-3 flex items-center gap-2 sm:gap-3 border border-amber-500/30 mx-2 max-w-[95%] sm:max-w-none z-20">

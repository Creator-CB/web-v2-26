...
const HeroActiveInvestors = () => {
  ...
  return (
    <div className="absolute bottom-6 sm:bottom-10 left-1/2 transform -translate-x-1/2 bg-black/50 backdrop-blur-md shadow-lg rounded-full px-2 sm:px-6 py-2 sm:py-3 flex items-center gap-1 sm:gap-3 border border-amber-500/30 mx-1 w-fit max-w-[98vw] sm:max-w-max z-20">

  ...
  const steps = [
    {
      ...
      image: "https://images.unsplash.com/photo-1596526131083-e8c633c948d2?auto=format&fit=crop&q=80&w=400"
    },
    {
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?auto=format&fit=crop&q=80&w=400"
    },
    {
    ...
    <section id="how-it-works" className="section-padding relative overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute top-28 left-1/2 transform -translate-x-1/2 w-4/5 h-1 bg-gradient-to-r from-pink-500/20 via-purple-500/30 to-blue-400/20 rounded-full hidden md:block"></div>

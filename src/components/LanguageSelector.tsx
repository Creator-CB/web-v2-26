...
export const useLanguage = () => {
  ...
  const translations: Record<string, Record<TranslationKey, string>> = {
    en: {
      ...
      subheadline: "Start earning with strategy from just €299.",
      startNow: "Start now with €299",
      ...
      testimonialText1: "Started with €299, now have a €3,500 portfolio in 2 months. Didn't think it was possible to get such results in such a short time!",
      ...
      startToday: "Start today with €299",
    ...
    it: {
      ...
      subheadline: "Inizia a guadagnare con strategia da soli 299 €.",
      startNow: "Inizia ora con 299 €",
      ...
      testimonialText1: "Ho iniziato con 299 €, ora ho un portafoglio di 3.500 € in 2 mesi. Non pensavo fosse possibile ottenere tali risultati in così poco tempo!",
      testimonialUser2: "Maria L.",
      ...
      startToday: "Inizia oggi con 299 €",
